...
public final class HistoryManager: ObservableObject {
    ...
    private func clearThumbnailFiles(preserving activeIDs: Set<UUID>) {
        ...
        guard let enumerator = FileManager.default.enumerator(at: thumbnailsDir, includingPropertiesForKeys: [.isRegularFileKey], options: [.skipsHiddenFiles]) else { return }
